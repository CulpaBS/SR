...
\clearpage
\section{Conclusion}
We have shown the theory behind map-scan producer-consumer fusion resulting in the SOAC scanomap, with the addition of scanomap-scanomap horizontal fusion. Additionally we have documented a GPU speedup in the range 1.2-1.5 times faster then pre-scanomap implementation. Our implementation of scanomap has also opened the door for additional optimisations as \texttt{scanomap-map} fusion, with the chance of improving execution time even further.
\newpage
